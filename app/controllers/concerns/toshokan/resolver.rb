module Toshokan
  module Resolver
    ...
    def get_resolver_result(params)
      ...
      res = repository.connection.send_and_receive('resolve', :params => search_builder.add_inclusive_access_filter(params))
      solr_response = Blacklight::Solr::Response.new(res, params)
      count = 0
