...
describe AssistanceRequest do
  ...
  describe "#openurl" do
    ...
    it "creates an OpenURL from a journal article assistance request" do
      ...
      ar.openurl.kev.should include "rft.atitle=test+title&rft.jtitle=test+journal+title&rft.volume=1&rft.issue=2&rft.date=2014&rft.pages=34&rft_val_fmt=info%3Aofi%2Ffmt%3Akev%3Amtx%3Ajournal"
    end
  end
end
